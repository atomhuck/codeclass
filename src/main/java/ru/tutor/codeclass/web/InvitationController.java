...
import ru.tutor.codeclass.service.ConnectionService;
import ru.tutor.codeclass.service.InvitationService;
...
public class InvitationController {
    ...
    private User authenticatedUser(Authentication authentication) {
        if (authentication == null || !authentication.isAuthenticated()
                || !(authentication.getPrincipal() instanceof CodeClassPrincipal principal)) return null;
